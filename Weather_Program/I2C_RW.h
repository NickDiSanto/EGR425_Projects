...
class I2C_RW
{
    public:
        ...
        static int i2cAddressVCNL;
        static int i2cAddressSHT;

        // Initialization and debugging methods
        static void initI2C(int i2cVCNLAddress, int i2cSHTAddress, int i2cFreq, int pinSda, int pinScl);
        ...
        static float* readTempHumidityData(byte regAddr, int numBytesToRead, String action, bool verbose);
};
